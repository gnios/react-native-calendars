			...
			>
				...
				<Calendar // style={styles.calendar}
					...
					theme={{
						...
						arrowColor: "white", // textDisabledColor: 'red',
				...
				<Calendar
					...
					markedDates={{
						"2018-03-01": {
							customStyles: {
								container: { backgroundColor: "white", elevation: 2 },
								text: { color: "red" },
							},
						},
						...
						"2018-03-09": {
							customStyles: {
								container: { backgroundColor: "red", elevation: 4 },
								text: { color: "white" },
							},
						},
						"2018-03-14": {
						...
						"2018-03-28": {
							customStyles: { text: { color: "black", fontWeight: "bold" } },
						},
						"2018-03-30": {
							customStyles: {
								container: {
								...
								text: { marginTop: 3, fontSize: 11, color: "black" },
							},
						},
						"2018-03-31": {
							customStyles: {
								container: { backgroundColor: "orange", borderRadius: 0 },
							},
						},
					}}
				/>
